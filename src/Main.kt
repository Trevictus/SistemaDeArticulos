fun main(){
    ...
    val ordenador1: Articulo = Ordenador(TipoOrdenador.BASICO, "Lenovo", 399.99, Articulo.generarId())
    val ordenador2: Articulo = Ordenador(TipoOrdenador.GAMING, "Asus", 1299.99, Articulo.generarId())
